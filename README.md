...
By performing an example of memristor circuit simulation considering parasitic effect (Resistance and Capacitance), the desired parameters are inputted into the circuit level tool GUI as shown in Fig. 104 below.
